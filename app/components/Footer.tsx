    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">BuildNext</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">ul. Budowlana 123, Warszawa 00-001</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone size={20} className="text-yellow-400 shrink-0" />
                <span className="text-gray-400">+48 555 123 456</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={20} className="text-yellow-400 shrink-0" />
                <span className="text-gray-400">info@buildnext.pl</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} BuildNext. Wszelkie prawa zastrzeżone.</p>
        </div>
      </div>
    </footer>
  );
