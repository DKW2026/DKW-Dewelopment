...
export const metadata: Metadata = {
  ...
  description: 'Poznaj DKW DEVELOPMENT - wiodącą firmę budowlaną z 11-letnim doświadczeniem. Budujemy z doskonałością, innowacją i zaangażowaniem od 2010 roku. Ponad 400 udanych projektów.',
  openGraph: {
    title: 'O DKW DEVELOPMENT - Nasza Historia i Wartości',
    description: 'Poznaj naszą historię, misję i wartości. DKW DEVELOPMENT buduje doskonałość z zaangażowaniem i innowacją od 2010 roku.',
  },
};
    ...
    <div>
      ...
      <section className="bg-primary text-primary-foreground py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">O DKW DEVELOPMENT</h1>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Nasza Historia</h2>
              <p className="text-muted-foreground mb-4">
                DKW DEVELOPMENT został założony w 2010 roku z wizją przekształcenia branży budowlanej
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-card p-10 rounded-lg shadow-md">
              ...
              <h3 className="text-3xl font-bold mb-4">Nasza Misja</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card p-10 rounded-lg shadow-md">
              ...
              <h3 className="text-3xl font-bold mb-4">Nasza Wizja</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Podstawowe Wartości Kierujące Każdym Projektem</h2>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">W Liczbach</h2>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Budujemy by Trwało</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Jakość Rzemiosła</h3>
                <p className="text-muted-foreground">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Bezpieczeństwo Przede Wszystkim</h3>
                <p className="text-muted-foreground">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Infrastruktura Przyszłości</h3>
                <p className="text-muted-foreground">
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Gotowy, by Zbudować Coś Wspaniałego?</h2>
